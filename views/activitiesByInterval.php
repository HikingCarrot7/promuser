...
<script>
    ...
    $(document).ready(function(){
        $('#buttonActivitiesPerInterval').html('<button id="modalButton1" onclick="showTableActivitiesPerInterval()" style="width: 100%;" type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal"> Ver detalle</button>');
        $('#buttonActivitiesPerDay').html('<button id="modalButton2" onclick="showTableActivitiesPerDay()" style="width: 100%;" type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal"> Ver detalle</button>');
    })
</script>
</html>