    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <span><strong>Estudiante: </strong><span class="student-name">Moisés B.</span></span>
          <hr>
          <strong>Fecha de inicio: </strong><span class="first-date-user"></span><br>
          <strong>Fecha final: </strong><span class="last-date-user"></span>
          <hr>
          ...
          <div id="mostrarGrafica">
            <a style="color:green;cursor:pointer" onclick="showGraphic()">
              Mostrar gráfico de las sesiones
            </a>
          </div>
        </div>
