...
$resultado = $DB->get_records_sql("SELECT * FROM mdl_logstore_standard_log where (userid = " . $_POST['idUser'] . ") AND (target != 'config_log') AND (userid <> " . $USER->id . ") ORDER BY timecreated ASC");
